            ...
            <Container className="artist-home-container">
                ...
                {artistPosts.map((post) =>
                    ...
                    <Col lg>
                        ...
                        <p> Let me introduce myself, I am Nadya Poklad, an artist born in Ukraine. From a very young age, I discovered my passion for music and the arts, and dedicated myself to cultivating my talent as a composer, pianist, and prose writer. </p>
